...
function randomExcluded(min, max, excluded) {
  ...
  function startgame() {
    ...
    $('#game').addClass('in-game').html('<h2 class="gameheading">Happy Valentine</h2><div id="game-target"></div><div id="game-main"></div><div id="score">0</div><div id="counter">30</div>');
  ...
  $(document).ready(function() {
    ...
    $('#game').html('<div class="intro"><h2 class="gameheading"><span>Wanted</span> Dead or alive</h2><p>Find the wanted character quickly before they move to earn 5 points, click on the wrong character and lose a point but work fast, you only have <strong>30 seconds</strong>! <span style="display: block;margin-top: 10px"><strong>Have Fun!</strong></span></p><button id="startgame">Start Game</button></div>');
