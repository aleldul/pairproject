...
function randomExcluded(min, max, excluded) {
  ...
  function startgame() {
    ...
    $('#game').addClass('in-game').html(`<h2 class="gameheading">WORLD CUP</h2><div id="game-target"></div><div id="game-main"></div><div id="score">0</div><div id="counter">${dataGame.time}</div>`);
